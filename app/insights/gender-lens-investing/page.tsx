...
export default function Page() {
  const article = getArticleBySlug("gender-lens-investing");
  if (!article) return (
    <div style={{ paddingTop:120, textAlign:"center", minHeight:"60vh", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
      <h1 style={{ fontFamily:"var(--font-display)", fontSize:"2rem", marginBottom:"1rem" }}>Women innovated businesses are the best</h1>
